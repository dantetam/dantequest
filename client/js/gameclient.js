            ...
            if(dispatcherMode) {
                ...
                this.connection.on("dispatched", function(reply) {
                    ...
                    if(reply.status === 'OK') {
                        ...
                        console.log("DanteQuest is currently at maximum player population. Please retry later.");
                    } else {
                        console.log("Unknown error while connecting to DanteQuest.");
                    }
                });
                ...
                this.connection.on("disconnect", function() {
                    ...
                    if(self.disconnected_callback) {
                        if(self.isTimeout) {
                            ...
                            self.disconnected_callback("The connection to DanteQuest has been lost");
                        }
                    }
                });
            }
